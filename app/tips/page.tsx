	...
	return (
		<>
			...
			<div className="h-screen flex flex-col items-center justify-center bg-primary">
				...
				<span className="text-white">Otimize suas postagens nas redes sociais com dicas práticas. Aprenda a criar conteúdo envolvente, escolher as melhores imagens e escrever legendas cativantes.</span>
			</div>
			<svg
