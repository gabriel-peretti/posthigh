	...
	return (
		<>
			...
			<div className="h-screen flex flex-col items-center justify-center bg-primary">
				<span className="text-white">Estratégias de crescimento nas redes sociais</span>
				<span className="text-white">Descubra estratégias comprovadas para aumentar o alcance e o envolvimento nas redes sociais. Aprenda a conquistar seguidores, construir autoridade e alcançar resultados notáveis.</span>
			</div>
			<svg
